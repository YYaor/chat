...
@interface GYRLegendView ()

@property (nonatomic, strong) UIFont *legendFont;

@end

@implementation GYRLegendView

void GRY_CGContextAddRoundedRect(CGContextRef c, CGRect rect, CGFloat radius) {
...
void GRY_CGContextFillRoundedRect(CGContextRef c, CGRect rect, CGFloat radius) {
	CGContextBeginPath(c);
	GRY_CGContextAddRoundedRect(c, rect, radius);
	CGContextFillPath(c);
}
...
- (void)drawRect:(CGRect)rect {
	...
	GRY_CGContextFillRoundedRect(c, self.bounds, LEGEND_ROUND_RADIUS);
