...
-(void)setUpChart{
	if (self.chartStyle == UUChartLineStyle) {
        if(!_lineChart){
            ...
            _lineChart.colorsArray = _colorsArray;
            _lineChart.yTextArray = _yTextArray;
            _lineChart.yValuesArray = _yValuesArray;
            _lineChart.lines=self.lines;
            _lineChart.StepCount=self.StepCount;
            _lineChart.topArr=_topArr;
            _lineChart.bottomArr=_bottomArr;
            _lineChart.isCustomSection=_isCustomSection;
            _lineChart.redPointArr=_redPointArr;
            _lineChart.nums = _nums;
        ...
        if ([self.dataSource respondsToSelector:@selector(UUChartMarkRangeInLineCharts:)]) {
            [_lineChart setCoverValues:[self.dataSource UUChartMarkRangeInLineCharts:self]];
        }
        //选择显示范围
        ...
        //设置步进数组
        [_lineChart setSteps:[self.dataSource UUChart_xStepArray:self]];
